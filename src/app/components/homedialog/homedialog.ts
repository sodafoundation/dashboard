...
export class HomeDialog implements AfterViewInit,AfterViewChecked,OnDestroy {
...
@NgModule({
    ...
    exports: [HomeDialog,SharedModule],
    declarations: [HomeDialog]
})
